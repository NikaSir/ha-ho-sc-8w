#!/usr/bin/env python3
"""Release safety contract for HO-SC-8W UI 0.7.05 / integration b006.26."""
...
assert '"version": "1.0.0-b006.26"' in manifest
assert 'PANEL_VERSION = "0.7.05"' in const
assert 'irrigation-panel-v0705.mjs' in const
...
ui_paths = [component / "frontend" / f"irrigation-panel-v{n:04d}.mjs" for n in range(688, 706)]
