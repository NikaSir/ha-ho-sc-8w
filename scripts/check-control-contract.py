#!/usr/bin/env python3
"""Release safety contract for HO-SC-8W UI 0.7.06 / integration b006.27."""
...
source = source.replace('EXPECTED_INTEGRATION_VERSION = "1.0.0-b005.87"',
                        'EXPECTED_INTEGRATION_VERSION = "1.0.0-b006.27"')
...
assert '"version": "1.0.0-b006.27"' in manifest
assert 'PANEL_VERSION = "0.7.06"' in const
assert 'irrigation-panel-v0706.mjs' in const
...
ui_paths = [component / "frontend" / f"irrigation-panel-v{n:04d}.mjs" for n in range(688, 707)]
