...
**Runtime:** `custom_components/nikas_ho_sc_8w/frontend/irrigation-panel.js` v0.6.12
**Manifest:** integration `1.0.0-b005.30`
...
| Meaningful typography 12–25 px | PASS | Final v0.6.12 rules raise semantic labels and values to 12 px or more and cap primary headings at 25 px; only the redundant control-wire caption remains 10 px. |
