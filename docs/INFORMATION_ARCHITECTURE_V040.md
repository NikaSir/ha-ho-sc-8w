...
> Historical UI v0.4 snapshot, retained for design lineage only. It is not the current navigation contract. Runtime v0.6.13 uses `Состояние · Зоны · Программа · Ручной · Диагн.` and the shell rules in `NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md` v1.8 plus `NIKAS_PANEL_NAVIGATION_CONTRACT.md`.
