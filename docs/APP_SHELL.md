...
- in `Программа → Параметры зон`, the still-mounted title and Refresh nodes are hidden while the centre shows the Zone 1–6 selector and the right plaque shows the factual state of that selected zone;
