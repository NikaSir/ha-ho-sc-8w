...
p.styles = function stylesV0628() {
  return `${baseStyles.call(this)}
    ...
    .headerTitle{appearance:none;justify-self:center;min-width:min(290px,100%);max-width:100%;min-height:44px;padding:5px 14px;border:1px solid color-mix(in srgb,var(--a,#03a9d9) 24%,var(--line,#dfe3e8));border-radius:16px;background:color-mix(in srgb,var(--a,#03a9d9) 5%,var(--card,#fff));box-shadow:0 5px 16px rgba(23,45,76,.06);color:var(--text);cursor:pointer}.headerTitle strong{font-size:23px;font-weight:800;line-height:1.05;letter-spacing:.08em}.headerTitle small{margin-top:3px;font-size:14px;font-weight:560;line-height:1.2;letter-spacing:.01em}.headerTitle:focus-visible{outline:2px solid var(--a,#03a9d9);outline-offset:2px}.headerTitle:active{background:color-mix(in srgb,var(--a,#03a9d9) 13%,var(--card,#fff));border-color:color-mix(in srgb,var(--a,#03a9d9) 42%,var(--line,#dfe3e8));box-shadow:0 2px 7px rgba(23,45,76,.05);transform:scale(.985)}
