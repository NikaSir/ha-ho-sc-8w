...
p.prepareZone7Duration17 = async function prepareZone7Duration17V0667() {
...
p.executeZone7Duration17 = async function executeZone7Duration17V0667() {
...
p._zone7LabCard = function zone7LabCardV0667(entities) {
...
p._ensureZone7LabEvents = function ensureZone7LabEventsV0667() {
...
p.styles = function stylesV0667() {
  return `${previousStyles.call(this)}
    /* UI v0.6.67 — guarded Zone 7 DP38 field laboratory in Diagnostics. */
