const SOURCE = 'custom_components/nikas_ho_sc_8w/frontend/irrigation-panel.js';
const FRONTEND = 'custom_components/nikas_ho_sc_8w/frontend';
const KIND = 'ho';
...
for (const testedSource of [SOURCE]) {
